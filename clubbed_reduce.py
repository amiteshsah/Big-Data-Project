...
print valid_CMPLNT_FR_TM,invalid_CMPLNT_FR_TM,null_CMPLNT_FR_TM,valid_X_COORD_CD,invalid_X_COORD_CD,null_X_COORD_CD,valid_Y_COORD_CD,invalid_Y_COORD_CD,null_Y_COORD_CD
