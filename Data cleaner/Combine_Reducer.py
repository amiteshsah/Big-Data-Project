...
for line in sys.stdin:
    ...
    temp_valriable = OFNS_DESC_Validator(temp_valriable)
    temp_valriable = Lat_Lon_validator(temp_valriable)
    temp_valriable= Lat_Lon_and_BORO_NM_validator(temp_valriable)
    print str(key)+'~'+str(temp_valriable[0])+'~'+str(temp_valriable[1])+'~'+str(temp_valriable[2])+'~'+str(temp_valriable[3])+'~'+str(temp_valriable[4])+'~'+str(temp_valriable[5])+'~'+str(temp_valriable[6])+'~'+str(temp_valriable[7])+'~'+str(temp_valriable[8])+'~'+str(temp_valriable[9])+'~'+str(temp_valriable[10])+'~'+str(temp_valriable[11])+'~'+str(temp_valriable[12])+'~'+str(temp_valriable[13])+'~'+str(temp_valriable[14])+'~'+str(temp_valriable[15])+'~'+str(temp_valriable[16])+'~'+str(temp_valriable[17])+'~'+str(temp_valriable[18])+'~'+str(temp_valriable[19])+'~'+str(temp_valriable[20])+'~'+str(temp_valriable[21])+'~'+str(temp_valriable[22])
